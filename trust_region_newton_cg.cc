// unconstrained optimization, trust region Newton conjugate gradient method (CG-Steihaug)
// inexact Netwon method
// Qi Liu, qiliu.nyu@gmail.com
//
// Algorith 4.1 Trust region, Cf. Nocedal, p69
// Solving trust region subproblem using CG(inexact method), Cf. Nocedal, p171
...
void fminunc_trust_region_newton_cg(int dim,
                            double (*f)(double x[]),
    ...
    while (true) {
        ...
        // solve subproblem
        trust_region_subproblem_cg(dim, hess, grad, delta, p);
